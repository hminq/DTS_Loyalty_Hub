...
public sealed class PrepareCustomerAccountRegisteredEventCommandHandlerTests
{
    ...
    {
        var command = new PrepareCustomerAccountRegisteredEventCommand(CampaignEvent);
    ...
    public async Task Handle_FirstDeliveryWithoutCandidates_CompletesParent()
    {
        ...
        result.Should().Be(new PrepareCustomerAccountRegisteredEventResult(
            CampaignEvent.EventId,
    ...
    private PrepareCustomerAccountRegisteredEventCommandHandler CreateHandler()
    {
        return new PrepareCustomerAccountRegisteredEventCommandHandler(
            _store.Object,
