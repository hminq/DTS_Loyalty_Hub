...
public sealed class GetCustomerVouchersRequestDtoValidator
    : AbstractValidator<GetCustomerVouchersRequestDto>
{
    public GetCustomerVouchersRequestDtoValidator()
    {
